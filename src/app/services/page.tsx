    ...
    <main className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-[#e0dcc8]/80 max-w-3xl mx-auto mb-6">
            Проведём ваш проект &laquo;за руку&raquo;, от&nbsp;А до&nbsp;Я —
            от геологической разведки и проектирования до полевых работ
          </p>
          <p className="text-lg text-[#d4af37]/90 max-w-2xl mx-auto font-medium">
        ...
        <div className="max-w-6xl mx-auto px-6 space-y-12">
          {services.map((service, index) => (
            <div
              key={service.id}
              id={service.id}
              className="scroll-mt-24 p-8 md:p-12 rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-[#d4af37]/30 transition-all duration-300"
            >
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <h2 className="text-3xl font-bold text-[#e0dcc8]">
                        {service.title}
                      </h2>
                    </div>
                  </div>
                  <p className="text-[#e0dcc8]/70 text-lg leading-relaxed mb-8">
                    {service.description}
                  </p>
                </div>
                  ...
                  <div className="p-6 rounded-2xl bg-white/5 border border-white/5">
                    ...
                    <ul className="space-y-3">
                      {service.capabilities.map((cap) => (
                        <li
                          key={cap}
                          className="flex items-center gap-3 text-[#e0dcc8]/70"
                        >
