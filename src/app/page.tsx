    ...
    <main className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden py-24">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-[#e0dcc8]/80 max-w-3xl mx-auto mb-6 leading-relaxed">
          ...
          <p className="text-base sm:text-lg text-[#d4af37]/90 max-w-2xl mx-auto mb-10 leading-relaxed font-medium">
      ...
      <section className="py-16 bg-[#0a0a0a]">
        <div className="max-w-4xl mx-auto px-6">
          <div className="relative flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-6 py-10 px-6 sm:px-12 rounded-3xl border border-[#d4af37]/20 bg-gradient-to-r from-[#1a1508]/50 via-[#0a0a0a] to-[#1a1508]/50">
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_rgba(212,175,55,0.05)_0%,_transparent_70%)]" />
            <div className="relative text-center">
              <div className="text-4xl sm:text-5xl md:text-6xl font-bold bg-gradient-to-r from-[#d4af37] via-[#f0d060] to-[#d4af37] bg-clip-text text-transparent">
                5+
              </div>
              <div className="text-[#e0dcc8]/60 text-sm mt-1">лет</div>
            </div>
            <div className="w-px h-px sm:h-16 sm:w-px bg-[#d4af37]/30" />
            <div className="relative">
              <p className="text-[#e0dcc8]/80 text-base sm:text-lg leading-relaxed">
      ...
      <section className="py-16 sm:py-24 bg-[#0a0a0a]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <p className="text-[#e0dcc8]/70 text-base sm:text-lg max-w-2xl mx-auto">
