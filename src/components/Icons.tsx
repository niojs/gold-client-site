...
export function DrillIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function GeologicalIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M2 22L6 8l4 6 4-10 4 8 4-6v14H2z" />
      <circle cx="12" cy="6" r="1.5" fill="currentColor" />
      <path d="M3 18c2-2 4-1 6-3s3-4 6-2 3 3 6 1" />
    </svg>
  );
}

export function WashIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M8 10c1 2 3 3 4 1" />
      <path d="M12 10c1 2 3 3 4 1" />
    </svg>
  );
}
...
export function LeafIcon({ className = "", size = 24 }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M17 8c4-1 7-4 7-7-3 0-6 3-7 7z" />
      <path d="M17 8c-4 4-8 8-14 12" />
    </svg>
  );
}
...
export function GoldBarIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M2 16l5-12h10l5 12H2z" />
      <path d="M7 4l3 6H4l3-6z" />
      <path d="M14 4l3 6h-6l3-6z" />
